...
<div class="main">
	...
	<div class="mymusic">
		...
		<div class="music_content">
			<?php foreach ($young_result as $key=>$one_result){ ?>
			<div class="one_song">
				<div class="one_song_first">
				<h3><i class="icon-music"></i> <?php echo $one_result->name ?></h3>
				<div>
				<audio controls="true" preload="none" id="youngsong<?php echo $key?>">
				...
				<div class="look_lyric" id="young_look_lyric_id<?php echo $key?>"> 查看歌词</div><br/><br/>
			...
			<div class="modal fade" id="young_myModal<?php echo $key?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
